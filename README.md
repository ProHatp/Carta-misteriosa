# Bem vindo ao Mystery Letter

Olá esse e mais um projeto feito por mim do curso da  **Trybe**. Esse projeto e um gerador de texto que, ao colocar o texto na caixa de texto gera aleatoriamente um estilo para ele e faz a contagem de quantas palavras tem na frase.

## Exemplo de uso

![enter image description here](https://i.imgur.com/BI6dOqb.gif)
